...
using JQueryDataTableData = net91com.Stat.Services.Entity.JQueryDataTableData;

namespace net91com.Reports.Services.HttpServices.R_UserAnalysis_Service
{
    public class HttpChannelCustomRetainUsers_Out : HttpServiceBase
    {
        public override string ServiceCategory
        {
            get { return "ChannelCustomRetainUsers_Out"; }
        }
        ...
        {
            get { return "Reports_New/R_UserAnalysis/ChannelCustomRetainUsers_Out.aspx"; }
        }
