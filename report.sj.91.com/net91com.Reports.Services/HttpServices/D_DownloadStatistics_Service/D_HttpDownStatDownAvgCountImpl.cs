...
{
    public class D_HttpDownStatDownAvgCountImpl : D_HttpDownStatDownAvgCountByVersionImpl
    {
        ...
        public override Result GetChart<T>(HttpContext context)
        {
            ...
            {
                var linename = GetLineName(1, lists[j][0]);
        ...
        {
            get { return "D_HttpDownStatDownAvgCountImpl"; }
        }
        ...
        {
            get { return "Reports_New/D_DownlaodStatistics/D_ResDownloadAvgCount.aspx"; }
        }
    }
}
