...
{
    public class D_HttpDownStatDownRankByClassMImpl : MAbs_HttpDownLoad
    {
        ...
        {
            get { return "资源下载排行（分类）.xls"; }
        }

        public override string ServiceCategory
        {
            get { return "D_HttpDownStatDownRankByClassImpl"; }
        }

        public override string ServiceName
        {
            get { return "资源下载排行（分类）"; }
        }
        ...
        {
            get { return "Reports_New/D_DownlaodStatistics/D_ResDownLoadRankByClass.aspx"; }
        }
        ...
        protected override List<List<Dictionary<string, string>>> GetData(HttpContext context, bool flag = false)
        {
            ...
            List<Dictionary<string, string>> result = D_StatDownRank_Service.Instance.GetD_StatDownRankByClassByCacheMap(restype, softs, platform,
                                                                                            comparebeforetime, restime, period, pcid, cid, downtype);
            if (result.Count == 0)
            {
