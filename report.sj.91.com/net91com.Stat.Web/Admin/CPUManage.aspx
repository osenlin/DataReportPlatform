<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CPUManage.aspx.cs" Inherits="net91com.Stat.Web.Admin.CPUManage" %>
    ...
    <div>
       ...
       <ext:Hidden ID="isSearch" runat="server" Text="0" />
        ...
        <ext:Viewport ID="Viewport2" runat="server" Layout="border"  >
              ...
              <ext:Panel ID="Panel2"  Border="true" Header="false"  runat="server" Region="North" Margins="4 4 4 4" Layout="FitLayout" Height="30"  >
                 ...
                 <ext:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <ext:Label ID="Label1" StyleSpec="margin-left:15px;margin-right:8px" Text="CPU:"
                            runat="server" />
          ...
          <ext:Panel ID="Panel3" runat="server" Title="CPU编辑(双击列进行修改)" Region="Center" Margins="0 4 0 4"    Layout="FitLayout"  Height="30" >
            <Items>
                 <ext:GridPanel Border="false" ID="GridPanel1" runat="server" AutoWidth="true" Layout="FitLayout"
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server">
                        <Columns>
                            <ext:Column DataIndex="ID" Width="120" Header="CPU ID" Editable="false" >
                            </ext:Column>
                            <ext:Column DataIndex="Lan" Width="150" Header="CPU" />
