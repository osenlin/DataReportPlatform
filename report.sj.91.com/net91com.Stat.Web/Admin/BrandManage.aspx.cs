...
{
    public partial class BrandManage : Stat.Web.Base.ReportBasePage 
    {
        ...
        protected void MyData_Refresh(object sender, StoreRefreshDataEventArgs e)
        {
            ...
            if (isSearch.Text == "1")
            {
                ...
                var list = Sjqd_BrandService.GetSjqd_LanList(hiddenlan.Text, hiddenlanname.Text, 0, pagecut.PageSize, out count);
            ...
            else
            {
                ...
                var list = Sjqd_BrandService.GetSjqd_LanList(hiddenlan.Text, hiddenlanname.Text, IndexSize, pagecut.PageSize, out count);
                Store3.DataSource = list;
                Store3.DataBind();
                (Store3.Proxy[0] as PageProxy).Total = count;
            }
        ...
        protected void HandleChanges(object sender, BeforeStoreChangedEventArgs e)
        {
            ...
            {
                Sjqd_BrandService.UpdateLan(updated);
