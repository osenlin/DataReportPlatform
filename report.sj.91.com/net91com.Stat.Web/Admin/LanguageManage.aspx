<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LanguageManage.aspx.cs" Inherits="net91com.Stat.Web.Admin.LanguageManage" %>
    ...
    <div>
       ...
       <ext:Hidden ID="isSearch" runat="server" Text="0" />
        ...
        <ext:Viewport ID="Viewport2" runat="server" Layout="border"  >
              ...
              <ext:Panel ID="Panel2"  Border="true" Header="false"  runat="server" Region="North" Margins="4 4 4 4" Layout="FitLayout" Height="30"  >
                 ...
                 <ext:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <ext:Label ID="Label1" StyleSpec="margin-left:15px;margin-right:8px" Text="语言:"
                            runat="server" />
                        <ext:TextField ID="txtlan" runat="server" />
                       
                        <ext:Label ID="Label3" StyleSpec="margin-left:15px;margin-right:8px" Text="语言名称:"
                            runat="server" />
          ...
          <ext:Panel ID="Panel3" runat="server" Title="语言编辑(双击列进行修改)" Region="Center" Margins="0 4 0 4"    Layout="FitLayout"  Height="30" >
            <Items>
                 <ext:GridPanel Border="false" ID="GridPanel1" runat="server" AutoWidth="true" Layout="FitLayout"
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server">
                        <Columns>
                            <ext:Column DataIndex="ID" Width="120" Header="语言ID" Editable="false" >
                            </ext:Column>
                            <ext:Column DataIndex="Lan" Width="150" Header="语言" />
                            <ext:Column DataIndex="E_Lan" Width="150" Header="语言名称"  >
                            <Editor>
