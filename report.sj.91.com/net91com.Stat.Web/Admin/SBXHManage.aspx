<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SBXHManage.aspx.cs" Inherits="net91com.Stat.Web.Admin.SBXHManage" %>
...
<body>
    ...
    <div>
       ...
       <ext:Hidden ID="hiddensbxh" runat="server" Text="" />
       <ext:Hidden ID="hiddensbxhname" runat="server" Text="" />
       <ext:Hidden ID="isSearch" runat="server" Text="0" />
        ...
        <ext:Viewport ID="Viewport2" runat="server" Layout="border"  >
              ...
              <ext:Panel ID="Panel2"  Border="true" Header="false"  runat="server" Region="North" Margins="4 4 4 4" Layout="FitLayout" Height="30"  >
                 ...
                 <ext:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <ext:Label ID="Label3" StyleSpec="margin-left:15px;margin-right:8px" Text="型号:"
                            runat="server" />
                        <ext:TextField ID="txtsbxh" runat="server" />

                        <ext:Label ID="Label5" StyleSpec="margin-left:15px;margin-right:8px" Text="型号名称:"
                            runat="server" />
                        <ext:TextField ID="txtsbxhname" runat="server" />
          ...
          <ext:Panel ID="Panel3" runat="server" Title="设备型号编辑(双击列进行修改)" Region="Center" Margins="0 4 0 4"    Layout="FitLayout"  Height="30" >
            <Items>
                 <ext:GridPanel Border="false" ID="GridPanel1" runat="server" AutoWidth="true" Layout="FitLayout"
                        ...
                        <Reader>
                            <ext:JsonReader IDProperty="ID">
                                <Fields>
                                    ...
                                    <ext:RecordField Name="SBXH" Type="String"  />
                                    <ext:RecordField Name="E_SBXH" Type="String"  />
                                </Fields>
                            </ext:JsonReader>
                        </Reader>
                        <Proxy>
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server">
                        <Columns>
                            <ext:Column DataIndex="ID" Width="120" Header="设备型号ID" Editable="false" >
                            </ext:Column>
                            <ext:Column DataIndex="SBXH" Width="150" Header="设备型号" />
                            <ext:Column DataIndex="E_SBXH" Width="150" Header="设备型号名称"  >
                            <Editor>
