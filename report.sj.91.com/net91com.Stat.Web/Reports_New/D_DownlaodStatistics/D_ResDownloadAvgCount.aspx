<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="D_ResDownloadAvgCount.aspx.cs" Inherits="net91com.Stat.Web.Reports_New.D_DownlaodStatistics.D_ResDownloadAvgCount2" %>
...
<script type="text/javascript">
    ...
    function getChart() {
        $.ajax({
            ...
            dataType: "json",
            data: {
                'service': 'D_HttpDownStatDownAvgCountImpl',
                'do': 'get_chart', 
                'endtime': $("#endTime").val(),
    ...
    function getTabsControl() {
        ...
        if (arr.length > 1 || arrchannel.length>1) {
            $("#mytags2").html(html);
    ...
    function gettabs(value,name) {
        ...
        oTable = $('#mytable').dataTable({
            ...
            "fnServerParams": function (aoData) {
                aoData.push({ "name": "service", "value": "D_HttpDownStatDownAvgCountImpl" });
                ...
                aoData.push({ "name": "modetype", "value": 1 });
    ...
    function setDownExcel() {
        var url = serverUrl + "?do=get_excel&stattype=1&service=D_HttpDownStatDownAvgCountImpl&projectsource=" + $("#selectprojectsources").val() + "&softs=" + $("#selectsofts").val()
            + "&plat=" + $("#selectplats").val() + "&begintime=" + $("#beginTime").val() + "&endtime=" + $("#endTime").val()
            + "&restype=" + $("#selectrestype").val() + "&version=-1&modetype=1&showtype=" + 3
            + "&channelids=" + channelControl.getSelectChannels() + "&channelnames=" + $("#mychanneltxt").val()+"&areaid=-1&areatype="+ g_areatype  
