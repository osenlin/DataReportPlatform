<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="D_ResDownLoadRankByArea_Identifier.aspx.cs" Inherits="net91com.Stat.Web.Reports_New.D_DownlaodStatistics.D_ResDownLoadRankByArea_Identifier" %>
    ...
    <head id="Head1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function gettabs() {
                ...
                oTable = $('#mytable').dataTable({
                    ...
                    "fnServerParams": function(aoData) {
                        aoData.push({ "name": "service", "value": "D_HttpDownStatDownRankByArea_IdentifierImpl" });
            ...
            function setDownExcel() {
                var url = serverUrl + "?do=get_excel&service=D_HttpDownStatDownRankByArea_IdentifierImpl&softs=" + $("#selectsofts").val()
                    + "&plat=" + $("#selectplats").val() + "&begintime=" + $("#beginTime").val() 
                    + "&restype=" + $("#selectrestype").val() 
                    + "&period=" + $("#hiddenperiod").val()+"&areaid="+$("#selectArea").val() +"&areatype="+ g_areatype+"&downtype="+$("#selectDownType").val()  ;
