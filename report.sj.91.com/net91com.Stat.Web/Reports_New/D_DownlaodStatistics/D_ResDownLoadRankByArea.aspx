<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="D_ResDownLoadRankByArea.aspx.cs" Inherits="net91com.Stat.Web.Reports_New.D_DownlaodStatistics.D_ResDownLoadRankByArea" %>
    ...
    <head id="Head1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function gettabs() {
                ...
                oTable = $('#mytable').dataTable({
                    ...
                    "fnServerParams": function(aoData) {
                        aoData.push({ "name": "service", "value": "D_HttpDownStatDownRankByAreaImpl" });
            ...
            function setDownExcel() {
                var url = serverUrl + "?do=get_excel&service=D_HttpDownStatDownRankByAreaImpl&softs=" + $("#selectsofts").val()
