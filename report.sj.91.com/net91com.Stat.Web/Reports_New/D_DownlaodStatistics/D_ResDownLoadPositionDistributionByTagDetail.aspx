<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="D_ResDownLoadPositionDistributionByTagDetail.aspx.cs" Inherits="net91com.Stat.Web.Reports_New.D_DownlaodStatistics.D_ResDownLoadPositionDistributionByTagDetail" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="HeadPositionDistributionbytagdetail" runat="server">
        <title>下载位置分布</title>
        ...
        <script type="text/javascript">
            ...
            function initSelect() {
                ...
                $("#hiddenisdiffpagetype").val(array[11]);
                $("#hiddenstattype").val(array[12]);
                $("#hiddenareaid").val(array[13]);
            }
            ...
            function getChart() {
                $.ajax({
                    ...
                    dataType: "json",
                    data: {
                        'service': 'D_HttpDownStatDownPositionDistributionByTagDetailImpl',
                        'do': 'get_chart',
                        'endtime': $("#endTime").val(),
            ...
            function getSetting() {
                var defaultSetting={
                    ...
                    "fnServerParams": function(aoData) {
                        aoData.push({ "name": "service", "value": "D_HttpDownStatDownPositionDistributionByTagDetailImpl" });
            ...
            function setDownExcel() {
                ...
                var url = serverUrl + "?do=get_excel&service=D_HttpDownStatDownPositionDistributionByTagDetailImpl&projectsource=" + $("#hiddenprojectsource").val() + "&softs=" + $("#hiddensoftid").val()
                    ...
                    + "&period=" + $("#hiddenperiod").val() + "&positionid=" + $("#hiddenpositionid").val()
                    + "&isdiffpagetype=" + $("#hiddenisdiffpagetype").val() + "&stattype=" + $("#hiddenstattype").val() + "&areaid=" + $("#hiddenareaid").val();
    ...
    <body>
        ...
        <form id="form1" runat="server">
            ...
            <div class="maindiv">
                ...
                <input type="hidden" value="" id="hiddenisdiffpagetype" />
