<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="D_ResDownLoadSumByAreaDistributionl.aspx.cs" Inherits="net91com.Stat.Web.Reports_New.D_DownlaodStatistics.D_ResDownLoadSumByAreaDistributionl" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        ...
        <script type="text/javascript">
            ...
            var tableHtml = "<tr><th rowspan=\"2\"  style=\"width: 20px\">排名</th><th rowspan=\"2\" style=\"width: 30px\" >地区</th> <th colspan=\"5\" >下载点击</th> <th colspan=\"3\" >游戏下载</th> <th colspan=\"2\" >下载情况</th> <th colspan=\"2\">安装情况</th></tr><tr><th>所有</th><th>去除更新</th><th >静默更新</th>";
            tableHtml += "<th>来自搜索 </th><th>排期下载</th> <th > 所有 </th> <th > 去除更新 </th> <th > 来自搜索 </th><th >下载成功</th><th >下载失败</th>";
            tableHtml += "<th>安装成功</th><th>安装失败</th></tr>";
            var tableHtml_46 = "<tr><th rowspan=\"2\"  style=\"width: 20px\">排名</th><th rowspan=\"2\" style=\"width: 30px\">地区</th> <th colspan=\"5\" >下载点击</th> <th colspan=\"3\" >下载成功</th> <th colspan=\"3\" >下载失败</th> <th colspan=\"3\">安装成功</th> <th colspan=\"3\">安装失败</th></tr><tr><th>所有</th><th>去除更新</th>";
            ...
            $(function() {
                ...
                softControl = createSelectControl("selectsofts", '请选择软件', false, function() {
                    ...
                    g_areatype = SoftAreaJson[$("#selectsofts").val()];
            ...
            function getSetting(softid) {
                var defaultSetting={
                    ...
                    "fnServerParams": function(aoData) {
                        aoData.push({ "name": "service", "value": "D_HttpDownStatDownCountSumByAreaDistributionImpl" });
            ...
            function getChart() {
                $.ajax({
                    ...
                    dataType: "json",
                    data: {
                        'service': 'D_HttpDownStatDownCountSumByAreaDistributionImpl',
                        'do': 'get_chart',
                        'endtime': $("#endTime").val(),
                    ...
                    success: function(data) {
                        if (data.resultCode == 0) {
                            ...
                            createPie("container","下载量地区分布", obj);
                            gettabs();
                        } else {
                            alert(data.message);
                        }
            ...
            function setDownExcel() {
                ...
                var url = serverUrl + "?do=get_excel&service=D_HttpDownStatDownCountSumByAreaDistributionImpl&projectsource=" + $("#selectprojectsources").val() + "&softs=" + $("#selectsofts").val()
