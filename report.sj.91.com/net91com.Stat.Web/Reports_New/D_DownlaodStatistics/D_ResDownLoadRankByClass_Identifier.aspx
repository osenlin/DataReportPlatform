<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="D_ResDownLoadRankByClass_Identifier.aspx.cs" Inherits="net91com.Stat.Web.Reports_New.D_DownlaodStatistics.D_ResDownLoadRankByClass_Identifier" %>
    ...
    <head id="Head1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function gettabs() {
                ...
                oTable = $('#mytable').dataTable({
                    ...
                    "fnServerParams": function(aoData) {
                        aoData.push({ "name": "service", "value": "D_HttpDownStatDownRankByClass_IdentifierImpl" });
            ...
            function setDownExcel() {
                ...
                var url = serverUrl + "?do=get_excel&service=D_HttpDownStatDownRankByClass_IdentifierImpl&softs=" + $("#selectsofts").val()
...
<script type="text/javascript">
    ...
    function getbigcate() {
        ...
        if ($('#selectsofts').val()==-2) {
            ...
            softareatype = 2;
        }else if ($('#selectsofts').val()==113938) {
            softareatype = 3;
        }
        $.getJSON(serverUrl,
            {
