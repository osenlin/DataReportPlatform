<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatRetainedActiveUsers.aspx.cs"
    Inherits="net91com.Stat.Web.Reports.StatRetainedActiveUsers" EnableViewState="false"
...
<body>
    ...
    <div class="main">
        ...
        <div class="tablehead helpclass_head">
            <span class="helpclass_span1">&nbsp;&nbsp;活跃用户留存率(海外)</span><span class="helpclass_span2">
