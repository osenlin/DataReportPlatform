<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResolutionReport.aspx.cs"
    Inherits="net91com.Stat.Web.Reports.TransverseReports.ResolutionReport" %>
    ...
    <title>分辨率分布</title>
     ...
     function showLine(ix, gjbb) {
         ...
         function getchart2(ix, gjbb) {
            var url = "ServerHandler.ashx?act=getresolutionline&soft=" + soft + "&plat=" + platform + "&sdate=" + begintime +
            "&edate=" + endtime +  "&resolutionname=" + escape(gjbb) + "&n=" + Math.random();
...
<body>
    ...
    <div class="main">
        ...
        <div class="tablehead helpclass_head" style="display:none;">
            <span class="helpclass_span1">&nbsp;&nbsp;分辨率分布 </span><span class="helpclass_span2">
                <a id="A1" href="../helphtm/Resolution.htm" class="jTip">
