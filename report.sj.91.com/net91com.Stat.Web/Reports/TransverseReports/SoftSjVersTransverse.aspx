<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoftSjVersTransverse.aspx.cs"
    Inherits="net91com.Stat.Web.Reports.TransverseReports.SoftSjVersTransverse" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function getchart2(ix, areaname) {
            var url = "ServerHandler.ashx?act=getsoftversionline&soft=" + soft + "&plat=" + platform + "&sdate=" + begintime +
            "&edate=" + endtime +  "&versionname=" + escape(areaname) + "&n=" + Math.random();
        ...
        $(function () {
                ...
                var soft='<%=softsid %>';
                var zhouqi='<%=(int)Period %>';
                var url = "ServerHandler.ashx?act=" + act + "&platform=" +platform + "&soft=" + soft + "&zhouqi=" + zhouqi + "&mytp=" + mytp+"&rds="+encodeURIComponent(new Date());
