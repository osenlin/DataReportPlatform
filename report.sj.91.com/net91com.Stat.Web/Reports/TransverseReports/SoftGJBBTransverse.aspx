<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoftGJBBTransverse.aspx.cs" Inherits="net91com.Stat.Web.Reports.TransverseReports.SoftGJBBTransverse" %>
      ...
      <script type="text/javascript">
        ...
        function showLine(ix, gjbb) {
         ...
         function getchart2(ix, gjbb) {
            var url = "ServerHandler.ashx?act=getgjbbdetail&soft=" + soft + "&plat=" + platform + "&sdate=" + begintime +
            "&edate=" + endtime +  "&gjbbname=" + escape(gjbb) + "&n=" + Math.random();
