<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoftLanTransverse.aspx.cs"
    Inherits="net91com.Stat.Web.Reports.TransverseReports.SoftLanTransverse" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function getchart2(ix, areaname) {
            var url = "ServerHandler.ashx?act=getlandetail&soft=" + soft + "&plat=" + platform + "&sdate=" + begintime +
            "&edate=" + endtime +  "&lanname=" + escape(areaname) + "&n=" + Math.random();
