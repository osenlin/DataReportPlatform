<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatRetainedUsersByArea.aspx.cs"
    Inherits="net91com.Stat.Web.Reports.StatRetainedUsersByArea" EnableViewState="false"
...
<body>
    ...
    <div class="main">
        ...
        <div class="tablehead helpclass_head">
            <span class="helpclass_span1">&nbsp;&nbsp;新增用户留存率(地区)</span><span class="helpclass_span2">
