<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatUsersByArea.aspx.cs"
    Inherits="net91com.Stat.Web.Reports.StatUsersByArea" EnableViewState="false"
    ...
    <div class="main">
        ...
        <div>
            <div class="tablehead" style="margin-top: 3px">
                <span class="helpclass_span1">&nbsp;&nbsp;分地区统计 </span>
            </div>
            <div>
