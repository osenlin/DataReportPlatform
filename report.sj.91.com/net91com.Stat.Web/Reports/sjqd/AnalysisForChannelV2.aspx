<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnalysisForChannelV2.aspx.cs" Inherits="net91com.Stat.Web.Reports.AnalysisForChannelV2" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function geturl() {
            ...
            var url = "../AllHandler.ashx?action=downloadforoutcustom&" + "excelplatform=" + plat + "&excelsoft=" + escape(soft) + "&inputtimestart=" + begintime + "&inputtimeend=" + endtime + "&p=" + p + "&rds=" + encodeURIComponent(new Date());
