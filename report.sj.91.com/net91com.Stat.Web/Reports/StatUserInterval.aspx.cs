...
{
    public partial class StatUserInterval : net91com.Stat.Web.Base.ReportBasePage
    {
        ...
        //列表
        public List<Sjqd_StatUsersByInterval> listAll = new List<Sjqd_StatUsersByInterval>();
        /// 平台id  
        ...
        {
            reportTitle = "使用间隔分布(针对选择时间范围内的活跃用户进行统计)";  
            AxisJsonStr = "{}";
            SeriesJsonStr = "[]"; 
        ...
        protected void BindData()
        {
            ...
            listAll = StatUsersByIntervalService.GetInstance().GetIntervalTimesByCache(begintime, endtime, SoftID, PlatformID);
            if (listAll.Count != 0)
            {
        ...
        {
            string str = "";
            foreach (StatUsersIntervalEnum item in Enum.GetValues(typeof(StatUsersIntervalEnum)))
            {
        ...
        protected void GetDataJsonList(List<Sjqd_StatUsersByInterval> temp)
        {
