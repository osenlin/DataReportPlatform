<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatUsersByAreaTransverse.aspx.cs"
    Inherits="net91com.Stat.Web.Reports.StatUsersByAreaTransverse" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function checkCondition() {
         ...
         function showLine(areaId) {

            if ($("#tr" + areaId).is(":hidden")) {
                ...
                $("#tr" + areaId).show();
                //若没有内容
                if ($.trim($("#div" + areaId).html()) == "") {
                    getchart2(areaId);
                }
            } else {

                $("#tr" + areaId).hide();
                $("#lbl" + areaId).text("查看每天");
            }
        }
        function getchart2(areaId) {
            var url = "<%= GetStatUsersByAreaLineUrl %>&AreaIds=" + areaId;
        ...
        $(function () {
                $("input[name='rdAreaType']").change(function(){
                            $('form:first').submit();
                        });
                 //tab 样式去除
    ...
    <div class="main">
        ...
        <div>
            <div class="tablehead" style="margin-top: 3px">
                <div>
                    <span class="helpclass_span1">&nbsp;&nbsp;地区分布 </span>
                </div>
            </div>
            <div>
                <table style="width: 100%">
                    <tr>
                        ...
                        <%--<td style="text-align: right; padding-right: 10px">
                            <input type="hidden" name="hAreaType" id="hAreaType" value="<%= AreaType %>" />
                            <input type="radio" name="rdAreaType" id="rdCountry" <%= AreaType==1 ? "checked=\"checked\"" : "" %> value="1" />国家&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="rdAreaType" id="rdProvince" <%= AreaType==2 ? "checked=\"checked\"" : "" %> value="2" />省&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="rdAreaType" id="rdCity" <%= AreaType==3 ? "checked=\"checked\"" : "" %> value="3" />市&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>--%>
                    </tr>
                </table>
            </div>
