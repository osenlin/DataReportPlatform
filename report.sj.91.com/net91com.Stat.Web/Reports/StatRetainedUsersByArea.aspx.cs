...
{
    public partial class StatRetainedUsersByArea : ReportBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HeadControl1.IsFirstLoad || Request["hAreaType"] != AreaType.ToString())
            {
                HeadControl1.CustomType = DefaultArea.EnShortName;
            }
            GetQueryString();
            BindData();
        }
